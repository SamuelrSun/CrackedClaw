      ...
      <div className="mt-2 space-y-3">
        ...
        <div className="relative">
          <textarea
            ...
            className="w-full min-h-[200px] p-4 bg-white border border-[rgba(58,58,56,0.2)] rounded-none font-mono text-sm leading-relaxed resize-y focus:outline-none focus:border-forest/50 transition-colors"
            autoFocus
          />
  ...
  return (
    <div className="mt-2 space-y-3">
      ...
      <div className="flex items-center gap-3">
        ...
        {showSaved && (
          <span className="font-mono text-[10px] text-[#1A3C2B] bg-mint/30 px-2 py-1">
            Saved!
          </span>
        )}
      </div>
