 ...
 *
 * Works best over images, gradients, or dark backgrounds.
 * On light/solid backgrounds it gracefully degrades to a soft tinted panel.
 */

type GlassVariant = "default" | "elevated" | "subtle";

interface GlassCardProps extends HTMLAttributes<HTMLDivElement> {
  /** Optional label rendered at the top of the card */
  label?: ReactNode;
  /** Visual intensity variant */
  variant?: GlassVariant;
  /** Accent color for the label bar (CSS color string) */
  accentColor?: string;
...
const variantStyles: Record<GlassVariant, {
  ...
  elevated: {
    ...
    shadow: "shadow-[0_12px_48px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.2)]",
  },
  subtle: {
    backdrop: "backdrop-blur-[12px] backdrop-saturate-[1.4]",
    bg: "bg-white/[0.08]",
    border: "border border-white/[0.12]",
    shadow: "shadow-[0_4px_16px_rgba(0,0,0,0.05),inset_0_1px_0_rgba(255,255,255,0.1)]",
  },
};
